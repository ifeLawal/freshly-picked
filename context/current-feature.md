...
- 2026-03-31: Search — SearchScreen rewritten from mock data to live API; `useQuery` with 300ms debounce calls `GET /recommendations?search=`; results rendered as `RecommendationCard`s; loading spinner and empty state; recent searches preserved via AsyncStorage (`sprint-03/03_search`)
